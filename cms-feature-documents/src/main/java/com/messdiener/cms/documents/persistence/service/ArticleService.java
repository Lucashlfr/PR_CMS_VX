...
import com.messdiener.cms.documents.persistence.map.ArticleMapper;
import com.messdiener.cms.documents.persistence.repo.ArticleRepository;
    ...
    public void ensureDefaultsForTypes() {
        for (ArticleType type : ArticleType.values()) {
            if (!repository.existsByArticleType(type)) {
                ...
                Article a = com.messdiener.cms.documents.domain.entity.Article.empty();
