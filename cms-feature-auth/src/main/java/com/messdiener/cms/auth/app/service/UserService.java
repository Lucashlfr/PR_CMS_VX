package com.messdiener.cms.auth.app.service;

import com.messdiener.cms.domain.auth.UserProvisioningPort;
import com.messdiener.cms.domain.person.PersonLoginDTO; // ACHTUNG: Domain-Pfad
...
public class UserService implements UserProvisioningPort {  // <— nur "implements" ergänzt
    ...
    @Override
    public void createSingleUser(PersonLoginDTO login) {  // Signatur unverändert
        try {
    ...
    @Override
    public void initializeUsersAndPermissions(List<PersonLoginDTO> persons) { // Signatur unverändert
        try {
