    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers(HttpMethod.GET, "/", "/go/**", "/storage/file/**", "/infos","/about","/contact", "/impressum", "/static/**", "/dist/**", "/img/**", "/file/**", "/css/**", "/script/**", "/download", "/output", "/public/**", "/health", "/js/**", "/fonts/**").permitAll()
